...
const EditProfile = () => {
      ...
      C_Experience: prev.C_Experience.map((exp, i) => {
        if (i === index) {
          ...
          if (
            ...
            exp.endDate &&
            value &&
            new Date(exp.endDate) <= new Date(value)
          ) {
            updatedExp.endDate = "";
          }
          return updatedExp;
      ...
      C_Education: prev.C_Education.map((edu, i) => {
        if (i === index) {
          ...
          if (
            ...
            edu.endDate &&
            value &&
            new Date(edu.endDate) <= new Date(value)
          ) {
            updatedEdu.endDate = "";
          }
          return updatedEdu;
  ...
  const validateForm = () => {
    ...
    if (!formData.C_PhoneNo.toString().trim()) newErrors.C_PhoneNo = "Phone number is required";
    ...
    if (formData.C_PhoneNo && !phoneRegex.test(formData.C_PhoneNo.toString().replace(/\D/g, "")))
    ...
    return (
      <>
        <div className="flex justify-center items-center h-screen">
          <ScaleLoader css={override} size={100} color={"#123abc"} loading={true} />
        </div>
      </>
    );
  }
      ...
      >
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-white opacity-90">Keep your professional information up to date</p>
          </div>
